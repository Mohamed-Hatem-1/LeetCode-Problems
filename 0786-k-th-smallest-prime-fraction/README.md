...
<p data-sider-select-id="e152bb75-69eb-4e2c-9648-108e345a7c58">For every <code>i</code> and <code>j</code> where <code>0 &lt;= i &lt; j &lt; arr.length</code>, we consider the fraction <code data-sider-select-id="c1964976-2c5c-41b4-88fc-63748e90f6a1">arr[i] / arr[j]</code>.</p>
...
<pre data-sider-select-id="f8127e80-ae2e-4f15-836d-53cc75d0d8a0"><strong>Input:</strong> arr = [1,2,3,5], k = 3
